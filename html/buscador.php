    ...
    <header>
        ...
        <nav class="navbar navbar-expand-lg navbar-light" style="background-color: #1d3557">
            <div class="container-fluid">
                <a class="navbar-brand" href="../index" style="color: white;">TursimoYopal</a>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav ml-auto">
                        <li class="nav-item">
                            <a class="nav-link" href="turismoHistorico" style="color: white;">Turismo histórico</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="dondeComprar" style="color: white;">¿Dónde comprar? <span class="sr-only">(current)</span></a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="dondeComer" style="color: white;">¿Dónde comer?</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="dondeAlojarse" style="color: white;">¿Dónde alojarse?</a>
                        </li>
                        <li class="nav-item">
    ...
    <div class="contenedor-form">
        <div class="form-buscar">
            <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="POST">
                <input type="text" name="search" pattern="[A-Za-z0-9_-]{1-50}" required placeholder="Busca aquí">
